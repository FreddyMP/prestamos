...
def create_db(nombre):
    try:
        ...
        insert_usuarios = "INSERT INTO Usuarios (correo, nombre, contrasena, id_rol, creado_por) VALUES ('testing@testing.com','Super_admin', '1234', 1, 1)"
        #insert_clientes = "INSERT INTO Usuarios (correo, contrasena, id_rol, creado_por) VALUES ('testing@testing.com', '1234', 1, 1)"
